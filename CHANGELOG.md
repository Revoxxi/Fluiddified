...
Releases and issue links for older versions below may still reference the upstream Fluidd repository (`fluidd-core/fluidd`) where those changes originated.
