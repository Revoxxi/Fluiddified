...
export const Globals = Object.freeze({
  ...
  /**
   * Host `config.json` must not hang forever (axios default timeout 0 = unlimited).
   * Stalled loads left the login spinner waiting on `appReady` without bound — common
   * with slow/broken DNS (e.g. `.local`) or a wedged dev server.
   */
  HOST_CONFIG_FETCH_MS: 25_000,
  /** Moonraker `/access/*` HTTP probes (global axios timeout is 0 = no limit). */
  AUTH_HTTP_PROBE_MS: 15_000,
  ...
  /** User-installed dashboard widget ZIPs + removed external catalog ids (browser local only). */
  LOCAL_USER_PLUGINS_STATE_KEY: 'fluiddifiedUserPlugins',
  ...
  MOONRAKER_DB: {
    fluidd: {
      ...
      ROOTS: {
        ...
        plugins: { name: 'plugins', dispatch: 'plugins/initPlugins' },
  ...
  /** Source docs live in `docs/docs/`; links open the matching Markdown on GitHub. */
  DOCS_ROOT: 'https://github.com/revoxxi/fluiddified/blob/master/docs/docs/index.md',
  DOCS_REQUIRED_CONFIGURATION: 'https://github.com/revoxxi/fluiddified/blob/master/docs/docs/configuration.md#initial-setup',
  DOCS_MULTIPLE_INSTANCES: 'https://github.com/revoxxi/fluiddified/blob/master/docs/docs/features/multiple-printers.md',
  DOCS_MOONRAKER_COMPONENTS: 'https://github.com/revoxxi/fluiddified/blob/master/docs/docs/configuration.md#moonraker',
  DOCS_AUTH_LOST_PASSWORD: 'https://github.com/revoxxi/fluiddified/blob/master/docs/docs/features/authorization.md#lost-password',
  DOCS_AUTH: 'https://github.com/revoxxi/fluiddified/blob/master/docs/docs/features/authorization.md',
  GITHUB_REPO: 'https://github.com/revoxxi/fluiddified'
})
